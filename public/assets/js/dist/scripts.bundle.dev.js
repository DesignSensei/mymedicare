  ...
  var e = !1,
    ...
    e.getAttributeNames().forEach(function (n) {
      if (/^data-tns-.*/g.test(n)) {
        var _r = n.replace("data-tns-", "").toLowerCase().replace(/(?:[\s-])\w/g, function (e) {
        ...
        } else t[_r] = "true" === (i = e.getAttribute(n)) || "false" !== i && i;
      }
  ...
  return {
    init: function init() {
      ...
      !function () {
        ...
        if (!t) return;
        var n = this.getAttribute("data-kt-card-confirm-message");
      ...
      }), (a = Array.prototype.slice.call(document.querySelectorAll("[data-bs-stacked-modal]"))) && a.length > 0 && a.forEach(function (e) {
        "1" !== e.getAttribute("data-kt-initialized") && (e.setAttribute("data-kt-initialized", "1"), e.addEventListener("click", function (e) {
          e.preventDefault();
          var t = document.querySelector(this.getAttribute("data-bs-stacked-modal"));
    ...
    initTinySlider: function initTinySlider(e) {
      o(e);
    },
    ...
    createBootstrapPopover: function createBootstrapPopover(e, t) {
      return i(e, t);
    },
    createBootstrapTooltip: function createBootstrapTooltip(e, t) {
      return n(e, t);
    }
  };
}();
...
var KTBlockUI = function KTBlockUI(e, t) {
  var n = this;
...
KTDialer.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-dialer="true"]';
...
var KTDrawerHandlersInitialized = !1,
    KTDrawer = function KTDrawer(e, t) {
  var n = this;
...
KTDrawer.getInstance = function (e) {
  ...
  var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-kt-drawer="true"]';
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-drawer="true"]';
  var t = document.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
...
var KTEventHandler = function () {
  var e = {},
    ...
    var o = KTUtil.getUniqueId("event"),
        a = KTUtil.data(_t).get(n);
    return a || (a = []), a.push(o), KTUtil.data(_t).set(n, a), e[n] || (e[n] = {}), e[n][o] = {
      name: n,
      callback: i,
      one: r,
      fired: !1
  ...
  return {
    trigger: function trigger(t, n, i) {
      return function (t, n, i) {
        var r,
            o = !0;
        if (!0 === KTUtil.data(t).has(n)) for (var a, l = KTUtil.data(t).get(n), s = 0; s < l.length; s++) {
          if (a = l[s], e[n] && e[n][a]) {
            var u = e[n][a];
...
KTImageInput.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "[data-kt-image-input]";
  var t = document.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
  ...
  if (null != e) {
    ...
    !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
      ...
      return function (e) {
        var t = h(e),
            n = k(t);
        if (null !== t && "dropdown" === v(t) && (l(t), n.length > 0)) for (var i = 0, r = n.length; i < r; i++) {
      ...
      return function (e) {
        var t = h(e);
        !0 !== n.disabled && null !== t && "hover" === L(t, "trigger") && ("1" === KTUtil.data(t).get("hover") && (clearTimeout(KTUtil.data(t).get("timeout")), KTUtil.data(t).remove("hover"), KTUtil.data(t).remove("timeout")), a(t));
      }(e);
    ...
    }, n.getLinkByAttribute = function (e) {
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "href";
      return function (e) {
        var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "href";
...
KTMenu.getInstance = function (e) {
...
}, KTMenu.updateByLinkAttribute = function (e) {
  var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "href";
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-menu="true"]';
  var t = document.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTMenu(t[n]);
  }
...
KTPasswordMeter.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "[data-kt-password-meter]";
...
var KTScrollHandlersInitialized = !1,
    KTScroll = function KTScroll(e, t) {
  var n = this;
  ...
  if (e) {
    var i = {
      ...
      var e,
          ...
          r = f("wrappers"),
          o = f("offset");
      if ((t -= m(n.element), null !== i) && (e = document.querySelectorAll(i)) && e.length > 0) for (var a = 0, l = e.length; a < l; a++) {
      ...
      return null !== o && "object" != _typeof(o) && (t -= parseInt(o)), String(t) + "px";
    },
        c = function c(e) {
      var t = 0;
...
KTScroll.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-scroll="true"]';
  var t = document.body.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTScroll(t[n]);
  }
...
KTScrolltop.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-scrolltop="true"]';
  var t = document.body.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTScrolltop(t[n]);
  }
  ...
  if (null != e) {
    var i = {
      ...
      n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("stepper"), n.element = e, n.element.setAttribute("data-kt-stepper", "true"), n.steps = KTUtil.findAll(n.element, '[data-kt-stepper-element="nav"]'), n.btnNext = KTUtil.find(n.element, '[data-kt-stepper-action="next"]'), n.btnPrevious = KTUtil.find(n.element, '[data-kt-stepper-action="previous"]'), n.btnSubmit = KTUtil.find(n.element, '[data-kt-stepper-action="submit"]'), n.totalStepsNumber = n.steps.length, n.passedStepIndex = 0, n.currentStepIndex = 1, n.clickedStepIndex = 0, n.options.startIndex > 1 && o(n.options.startIndex), n.nextListener = function (e) {
        ...
        if (e.preventDefault(), n.steps && n.steps.length > 0) for (var t = 0, i = n.steps.length; t < i; t++) {
...
var KTStickyHandlersInitialized = !1,
    KTSticky = function KTSticky(e, t) {
  var n = this;
  ...
  if (null != e) {
    var i = {
      ...
      if (null !== r && KTUtil.css(n.element, "right", r), null !== l) {
        ...
        if (g && g.length > 0) for (var v = 0, h = g.length; v < h; v++) {
...
KTSticky.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-sticky="true"]';
  var t = document.body.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTSticky(t[n]);
  }
...
var KTSwapperHandlersInitialized = !1,
    KTSwapper = function KTSwapper(e, t) {
  var n = this;
...
KTSwapper.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-swapper="true"]';
  var t = document.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTSwapper(t[n]);
  }
...
KTToggle.getInstance = function (e) {
  ...
  var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "[data-kt-toggle]";
  var t = document.body.querySelectorAll(e);
  if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) {
    new KTToggle(t[n]);
  }
...
var KTUtil = function () {
  ...
  return {
    ...
    isVisibleInContainer: function isVisibleInContainer(e, t) {
    ...
    getRelativeTopPosition: function getRelativeTopPosition(e, t) {
    ...
    isPartiallyInViewport: function isPartiallyInViewport(e) {
  ...
  return {
    init: function init() {
      ...
      (a = document.querySelector("#kt_app_engage"), s = document.querySelector("#kt_app_engage_toggle_on"), l = document.querySelector("#kt_app_engage_toggle_off"), u = document.querySelector("#kt_app_engage_prebuilts_modal"), a && u && (null !== u && "1" !== KTCookie.get("app_engage_prebuilts_modal_displayed") && setTimeout(function () {
        ...
        var e = u.querySelector('[data-kt-element="title"]'),
...
var KTThemeMode = function () {
  var e,
    ...
    return document.documentElement.hasAttribute("data-bs-theme") ? document.documentElement.getAttribute("data-bs-theme") : null !== localStorage.getItem("data-bs-theme") ? localStorage.getItem("data-bs-theme") : "system" === r() ? o() : "light";
      ...
      i = function i(_i2, r) {
    var l = n();
    "system" === r ? o() !== _i2 && (_i2 = o()) : _i2 !== r && (r = _i2);
    var s = e ? e.querySelector('[data-kt-element="mode"][data-kt-value="' + r + '"]') : null;
    document.documentElement.setAttribute("data-kt-theme-mode-switching", "true"), document.documentElement.setAttribute("data-bs-theme", _i2), setTimeout(function () {
      document.documentElement.removeAttribute("data-kt-theme-mode-switching");
    }, 300), localStorage.setItem("data-bs-theme", _i2), s && (localStorage.setItem("data-bs-theme-mode", r), a(s)), _i2 !== l && KTEventHandler.trigger(document.documentElement, "kt.thememode.change", t);
  },
      r = function r() {
    if (!e) return null;
...
var KTAppSidebarPanel = function () {
  ...
  return {
    init: function init() {
      var t;
      (e = document.querySelector("#kt_sidebar_panel_body")) && (t = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(t, e) && e.scroll({
      ...
      if (e) {
        var t = {
          ...
          rendered: !1
            ...
            n = function n() {
          var n = parseInt(KTUtil.css(e, "height")),
          ...
          t.self = new ApexCharts(e, o), t.self.render(), t.rendered = !0;
        };

        n(), KTThemeMode.on("kt.thememode.change", function () {
          t.rendered && t.self.destroy(), n();
        });
      }
    }(), function () {
...
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTCustomWidgets), KTUtil.onDOMContentLoaded(function () {
