      ...
      if ("undefined" != typeof am5) {
        ...
        if (e) {
          var t,
            ...
            var f,
                u = g.children.push(am5.Label["new"](t, {
              text: "United States",
              fontSize: 14,
              fontWeight: "500",
...
var KTChartsWidget7 = function () {
  var e = function e(_e3) {
    var t = document.querySelector(_e3);
...
var KTChartsWidget8 = function () {
  var e = {
    ...
    rendered: !1
      ...
      a = function a(e, t, _a, l, r) {
    var o = document.querySelector(_a);
  ...
  var e = {
    ...
    if (r && (!0 !== e.rendered || !r.classList.contains("initialized"))) {
      var o = parseInt(KTUtil.css(r, "height")),
          ...
          s = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
          n = KTUtil.getCssVariableValue("--bs-" + _a2),
          d = {
        series: [{
          name: "Lessons",
          data: l
...
var KTTimelineWidget1 = function () {
  var e = function e() {
    document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach(function (e) {
      e.addEventListener("shown.bs.tab", function (a) {
        "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && function () {
          var e = document.querySelector("#kt_timeline_widget_1_2");
          if (!e) return;
          ...
          var a = Date.now(),
            ...
            template: function template(e) {
              ...
              return t.forEach(function (e) {
                a += "<div class=\"symbol symbol-circle symbol-25px\"><img data-kt-timeline-avatar-src=\"".concat(l + e, "\" alt=\"\" /></div>");
              }), "<div class=\"rounded-pill bg-light-".concat(e.color, " d-flex align-items-center position-relative h-40px w-100 p-2 overflow-hidden\">\n                    <div class=\"position-absolute rounded-pill d-block bg-").concat(e.color, " start-0 top-0 h-100 z-index-1\" style=\"width: ").concat(e.progress, ";\"></div>\n        \n                    <div class=\"d-flex align-items-center position-relative z-index-2\">\n                        <div class=\"symbol-group symbol-hover flex-nowrap me-3\">\n                            ").concat(a, "\n                        </div>\n        \n                        <a href=\"#\" class=\"fw-bold text-white text-hover-dark\">").concat(e.content, "</a>\n                    </div>\n        \n                    <div class=\"d-flex flex-center bg-body rounded-pill fs-7 fw-bolder ms-auto h-100 px-3 position-relative z-index-2\">\n                        ").concat(e.progress, "\n                    </div>\n                </div>        \n                ");
            },
            onInitialDrawComplete: function onInitialDrawComplete() {
              t();
              var a = e.closest('[data-kt-timeline-widget-1-blockui="true"]'),
                  l = KTBlockUI.getInstance(a);
              l.isBlocked() && setTimeout(function () {
                l.release();
              }, 1e3);
            }
          };
          var s = new vis.Timeline(e, o, r, i);
          s.on("currentTimeTick", function () {
            s.off("currentTimeTick");
          });
        }(), "#kt_timeline_widget_1_tab_month" === e.getAttribute("href") && function () {
          var e = document.querySelector("#kt_timeline_widget_1_3");
          if (!e) return;
          if (e.innerHTML) return;
          var a = Date.now(),
              l = e.getAttribute("data-kt-timeline-widget-1-image-root"),
      ...
      t = function t() {
    var e = document.querySelectorAll("[data-kt-timeline-avatar-src]");
  ...
  return {
    init: function init() {
      (function () {
        var e = document.querySelector("#kt_timeline_widget_1_1");
        if (!e) return;
        if (e.innerHTML) return;
        var a = Date.now(),
            l = e.getAttribute("data-kt-timeline-widget-1-image-root"),
      ...
      })(), document.querySelectorAll('[data-kt-timeline-widget-1-blockui="true"]').forEach(function (e) {
        new KTBlockUI(e, {
...
var KTTimelineWidget4 = function () {
  var e = function e() {
    document.querySelectorAll('[data-kt-timeline-widget-4="tab"]').forEach(function (e) {
      e.addEventListener("shown.bs.tab", function (a) {
        "#kt_timeline_widget_4_tab_week" === e.getAttribute("href") && function () {
          var e = document.querySelector("#kt_timeline_widget_4_2");
          if (!e) return;
          if (e.innerHTML) return;
          var a = Date.now(),
            ...
            onInitialDrawComplete: function onInitialDrawComplete() {
              t();
              var a = e.closest('[data-kt-timeline-widget-4-blockui="true"]'),
                  l = KTBlockUI.getInstance(a);
              l.isBlocked() && setTimeout(function () {
                l.release();
              }, 1e3);
        ...
        }(), "#kt_timeline_widget_4_tab_month" === e.getAttribute("href") && function () {
          var e = document.querySelector("#kt_timeline_widget_4_3");
          if (!e) return;
          if (e.innerHTML) return;
          var a = Date.now(),
              l = e.getAttribute("data-kt-timeline-widget-4-image-root"),
        ...
        }(), "#kt_timeline_widget_4_tab_2022" === e.getAttribute("href") && function () {
          var e = document.querySelector("#kt_timeline_widget_4_4");
          if (!e) return;
          if (e.innerHTML) return;
          var a = Date.now(),
              l = e.getAttribute("data-kt-timeline-widget-4-image-root"),
  ...
  return {
    init: function init() {
      (function () {
        var e = document.querySelector("#kt_timeline_widget_4_1");
        if (!e) return;
        if (e.innerHTML) return;
        var a = Date.now(),
            l = e.getAttribute("data-kt-timeline-widget-4-image-root"),
      ...
      })(), document.querySelectorAll('[data-kt-timeline-widget-4-blockui="true"]').forEach(function (e) {
        new KTBlockUI(e, {
          overlayClass: "bg-body"
        }).block();
      }), e();
...
var KTTablesWidget3 = function () {
  ...
  var a = function a() {
    var e = document.querySelector('[data-kt-table-widget-3="filter_status"]');
  ...
  return {
    init: function init() {
      (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({
        ...
        var e = document.querySelector('[data-kt-table-widget-3="tabs_nav"]').querySelectorAll('[data-kt-table-widget-3="tab"]'),
            a = ["border-bottom", "border-3", "border-primary"];
        e.forEach(function (l) {
          l.addEventListener("click", function (r) {
            var _l$classList;

            var o = l.getAttribute("data-kt-table-widget-3-value");
            e.forEach(function (e) {
              var _e$classList;

              (_e$classList = e.classList).remove.apply(_e$classList, a), e.classList.add("text-muted");
            }), l.classList.remove("text-muted"), (_l$classList = l.classList).add.apply(_l$classList, a), "Show All" === o ? t.search("").draw() : t.search(o).draw();
          });
        });
      }(), a());
    }
...
var KTTablesWidget4 = function () {
  ...
  var l = function l() {
    var e = document.querySelector('[data-kt-table-widget-4="filter_status"]');
    $(e).on("select2:select", function (e) {
      var a = $(this).val();
      "Show All" === a ? t.search("").draw() : t.search(a).draw();
    });
    ...
    stock: "8"
      ...
      o = function o() {
    var e = document.querySelectorAll('[data-kt-table-widget-4="expand_row"]'),
        t = [3, 1, 3, 1, 2, 1];
    e.forEach(function (e, a) {
      e.addEventListener("click", function (l) {
        ...
        if (o.classList.contains("isOpen")) {
          ...
          (_o$classList = o.classList).remove.apply(_o$classList, s), e.classList.remove("active");
        } else i(n, o), (_o$classList2 = o.classList).add.apply(_o$classList2, s), e.classList.add("active");
      });
    });
  },
      i = function i(t, l) {
    t.forEach(function (r, o) {
      ...
      s = function s() {
    document.querySelectorAll('[data-kt-table-widget-4="subtable_template"]').forEach(function (e) {
      e.parentNode.removeChild(e);
    });
    e.querySelectorAll("tbody tr").forEach(function (e) {
  ...
  return {
    init: function init() {
      (e = document.querySelector("#kt_table_widget_4_table")) && (function () {
        var l = document.querySelector('[data-kt-table-widget-4="subtable_template"]');
...
var KTTablesWidget5 = function () {
  ...
  var a = function a() {
    var e = document.querySelector('[data-kt-table-widget-5="filter_status"]');
    $(e).on("select2:select", function (e) {
      var a = $(this).val();
      "Show All" === a ? t.search("").draw() : t.search(a).draw();
    });
  ...
  return {
    init: function init() {
      (e = document.querySelector("#kt_table_widget_5_table")) && (e.querySelectorAll("tbody tr").forEach(function (e) {
